<template>
    <div class="dark-toggle" :class="{ checked: checked }" @click="toggle">
        <div class="ball" :class="{ checked: checked }">
            <div v-show="!checked" class="sun">
...
.checked {
    ...
    &.ball {
        left: 30px;
        animation: toggle-ball 0.3s cubic-bezier(0.79, 0.33, 0.14, 0.53);
    }
