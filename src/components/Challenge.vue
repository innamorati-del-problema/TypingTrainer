<template>
  ...
  >
    <img
      class="m-10 w-5/6 self-center overflow-clip rounded-lg shadow-xl transition-transform group-hover:scale-110"
      :src="gif"
      alt=""
    />
    ...
    <div class="flex flex-col xl:flex-row xl:justify-around">
      <h1 class="self-center dark:text-white xl:ml-3">Livello</h1>
      <div class="m-3 flex self-center">
        <div
          @click="clicked(1)"
          :class="{
